                ...
                <div class="box" style="height: 57vh; background: #262322;">
                    <aside class="menu has-text-centered">
                        <ul class="menu-list">
                            ...
                            <li class="subtitle is-5">
                                <a id="clear-cart-modal-button" class="aside-link has-text-centered" style="background: #262322; color:white;">
                            ...
                            <li class="subtitle is-5">
                                <a href="sales.php" class="aside-link has-text-centered" style="background: #262322; color:white;">
                                    <span class="icon-text">
                                        <span class="icon">
  ...
  flex-direction: column;">
    ...
    <div id="clear-cart-modal-content" class="modal">
        ...
        <div class="modal-card">
            ...
            <footer class="modal-card-foot">
                <div class="columns">
                    <div class="column is-6"><button class="button is-danger is-fullwidth">Yes</button></div>
                    <div class="column is-6"><button id="close-clear-cart" class="button is-primary is-fullwidth">No</button></div>
                </div>
            </footer>
        </div>
    </div>
