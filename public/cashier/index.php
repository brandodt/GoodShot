                ...
                <div class="box" style="height: 57vh; background: #262322;">
                    <aside class="menu has-text-centered">
                        <ul class="menu-list">
                            ...
                            <li class="subtitle is-5">
                                <a id="search-modal-button" class="aside-link has-text-centered"
                            ...
                            <li class="subtitle is-5">
                                <a id="payment-modal-button" class="aside-link has-text-centered"
                                    style="background: #262322; color:white;">
                                    <span class="icon-text">
                                        <span class="icon">
                            ...
                            <li class="subtitle is-5">
                                <a id="clear-cart-modal-button" class="aside-link has-text-centered"
                                    style="background: #262322; color:white;">
                            ...
                            <li class="subtitle is-5">
                                <a href="sales.php" class="aside-link has-text-centered"
                                    style="background: #262322; color:white;">
                                    <span class="icon-text">
                                        <span class="icon">
            ...
            <footer class="modal-card-foot">
                <div class="columns">
                    ...
                    <div class="column is-6"><button id="close-clear-cart"
                            class="button is-primary is-fullwidth">No</button></div>
                </div>
            </footer>
        </div>
    </div>
